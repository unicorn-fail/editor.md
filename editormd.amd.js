...
;(function(factory) {
    ...
    editormd.prototype    = editormd.fn = {
         ...
         *
         * @returns {Mixed}                  return CodeMirror setting option
         *     value
         */
         ...
         *
         * @param   {String}   eventType          event type
         * @returns {editormd}                    this(editormd instance
         *     object.)
         */
         ...
         *
         * @param   {Object}    keyMap      KeyMap key/value
         *     {"(Ctrl/Shift/Alt)-Key" : function(){}}
         ...
         * Replace the text at the current cursor selected or insert a new
         ...
         * Search & replace
         *
         * @param   {String}     command    CodeMirror serach commands, "find,
         *     fintNext, fintPrev, clearSearch, replace, replaceAll"
         * @returns {editormd}              return this
         */
  ...
  editormd.keyMaps["Ctrl-L"] = function() {
    var cm        = this.cm;
    var cursor    = cm.getCursor();
    var selection = cm.getSelection();
  ...
  editormd.keyMaps["Shift-Ctrl-A"] = function() {
    var cm        = this.cm;
    var cursor    = cm.getCursor();
    var selection = cm.getSelection();
  ...
  editormd.keyMaps.F11 = "fullscreen";
    ...
    editormd.markedRenderer = function(markdownToC, options) {
        ...
        markedRenderer.emoji = function(text) {
            ...
            for (var i = 0, len = matchs.length; i < len; i++)
            {
                ...
                text = text.replace(new RegExp(matchs[i]), replaceFunc);
            }
        ...
        markedRenderer.link = function (href, title, text) {
            ...
            if (this.options.sanitize) {
                ...
                if (prot.indexOf("javascript:") === 0) { /* jshint ignore:line */
                    return "";
                }
            }
    ...
    editormd.isIE8   = (editormd.isIE && navigator.appVersion.match(/^8\./i));
